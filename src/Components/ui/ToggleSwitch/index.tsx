...
export const ToggleSwitch = ({ label, defaultChecked, setter }: {
  label: string
  ...
  return (
    ...
    >
      ...
      <div className='toggle-switch'>
        <input type='checkbox' className='checkbox' defaultChecked={isShowBalanceToggled}
          name={label} id={label} onClick={toggleHandler}/>
