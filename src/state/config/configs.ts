export default {
  56: {
    ...
    addresses: {
      ...
      // logic: '0x75862f94281ec74047047fef89abf1d6e95ca124',
      ...
      // powerPerpetual: '0x555712f659587a47267028656DEa18D26aDf06b3',
      logic: '0x555712f659587a47267028656DEa18D26aDf06b3',
      router: '0xa7Ee249b4186871B469f0b33Ef2675e4fcac8908',
      pool: '0x2449bc7351976601814cf95595F3C8046Bf41e25'
      // DToken0: 0xFFE34937F4486DdEa901e332f720523ddb307d37
      // DToken1: 0xfC4a7B7Bb09bD5C950E1d0D5c3266CA285b5ba7b
      // DToken2: 0xbbDF7765d0Fe3DCe6CA07664505662e3D772Cd8B
      // DToken3: 0xcD70A9269907f69870264a94CDb834cF6dAfb8b8
    }
  }
}
